...
const networks = {
  'optimism-mainnet': {
    ...
    subgraphUrl: 'https://api.studio.thegraph.com/query/63100/pt-v5-optimism/version/latest',
    vaults: '6', 
...
const prizeTiers = network.vaults
...
while (attempt < MAX_RETRIES) {
  ...
  try {
    ...
    // const remoteStatusUrl = `https://raw.githubusercontent.com/0xAnon0602/pooltogether-winners/refs/heads/main/winners/vaultAccounts`;
    ...
    execSync(command, {
      ...
      env: {
        ...
        PRIZE_TIERS_TO_COMPUTE: prizeTiers,
        DEBUG: true
      }
    });
